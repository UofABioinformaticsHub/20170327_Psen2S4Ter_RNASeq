...
The top [30 Overrepresented sequences](../output/top30Overrepresented.fa) were analysed using `blastn` and most were found to be [mitochondrial rRNA sequences](../output/top30Overrepresented_BlastResults.txt).
