...
The set of genes which was considered to be DE, and which belonged to either of the KEGG or HALLMARK gene-sets definining Oxidative Phosphorylation were then plotted in order to clarify differential expression for this gene set.

```{r, fig.cap = "DE genes belonging to either the KEGG or HALLMARK genesets definining Oxidative Phosphorylation."}
bind_rows(hm, kg) %>% 
  dplyr::filter(
    grepl("OXIDATIVE_PHOS", gs_name),
