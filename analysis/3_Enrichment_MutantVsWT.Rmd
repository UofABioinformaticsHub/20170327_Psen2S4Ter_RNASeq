...
```{r heatDsDNA, fig.height=6, fig.width=8, fig.cap="*All DE genes associated with the GO term 'Double Stranded DNA Binding'.*"}
go %>%
  dplyr::filter(
...
```{r heatOrganoNitro, fig.height=6, fig.width=8, fig.cap="*All DE genes associated with the GO term 'Organo-Nitrogen Compound Biosynthetic Process',* **excluding those genes which are additionally annotated to the GO term 'Ribosome'.**"}
go %>%
  dplyr::filter(
    gs_name %in% c(
