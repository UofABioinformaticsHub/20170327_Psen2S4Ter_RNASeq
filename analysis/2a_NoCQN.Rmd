...
This workflow is an exact replication of the differential gene expression analysis, however *conditional quantile normalisation* was not used.
This allows for a checking of the impact this method has had on the dataset.
...
Using these criteria, the following initial DE genesets were defined. These were slightly higher than previously
...
None of the results in this workflow were for analysis, but were simply to assess the impact of GC and lenght bias without accounting for it using CQN.
