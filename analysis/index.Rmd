...
The expected comparisons are shown below, however the final model was defined by fitting the wild-type samples, differences between heterozygotes and wild-type, followed by the difference between the two mutant genotypes
